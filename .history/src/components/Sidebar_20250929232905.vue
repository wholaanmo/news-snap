<template>
  <div class="account-page" :class="sidebarOpen && 'sidebar-open'">
...
.account-page {
  padding: 0.75rem;
  margin-top: 2rem;
  margin-left: calc(3.5rem + 32px); /* Default sidebar width when closed */
  transition: margin-left 0.5s ease-out; /* Match sidebar transition */
}
...
@media (max-width: 768px) {
  ...
  .account-page.sidebar-open {
    margin-left: 0 !important; /* Remove left margin on mobile even when sidebar is open */
  }
