  ...
  <aside :class="is_expanded && 'is_expanded'">
    <div class="menu">
      <router-link class="button" to="/admin/users">
        <span class="material-icons">User Management</span>
        <span class="text">Dashboard</span>
      </router-link>
      <router-link class="button" to="/admin/req">
        <span class="material-icons">assignment</span>
        <span class="text">Requests</span>
      </router-link>
      <router-link class="button" to="/admin/off">
        <span class="material-icons">front_hand</span>
        <span class="text">Offers</span>
      </router-link>
      <router-link class="button" to="/admin/acc">
