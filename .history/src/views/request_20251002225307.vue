        ...
        <div class="profile-sections">
          ...
          <div class="profile-section">
            ...
            <div class="id-verification">
              <span class="verification-status verified" v-if="currentProfile.governmentId">Verified</span>
              <span class="verification-status not-verified" v-else>Not Verified</span>
              <p v-if="currentProfile.governmentId" class="id-number">ID: {{ currentProfile.governmentId }}</p>
            </div>
          </div>
          ...
          <div class="profile-section">
            ...
            <div class="linked-accounts">
              <div class="account-item" v-for="account in currentProfile.linkedAccounts" :key="account.platform">
...
const userProfiles = {
  'Alex Johnson': {
    ...
    linkedAccounts: [
      { platform: 'Google', icon: 'account_circle' },
      { platform: 'Facebook', icon: 'thumb_up' },
  ...
  'Sarah Chen': {
    ...
    linkedAccounts: [
      { platform: 'Google', icon: 'account_circle' },
      { platform: 'Instagram', icon: 'camera_alt' }
    ],
    skillOffers: [
      {
        id: 103,
