      ...
      <div v-if="activeConversation" class="chat-container">
        ...
        <div class="message-input-container">
          ...
          <div v-if="selectedImage" class="image-preview">
            ...
            <button @click="removeImagePreview" class="remove-image">
...
const selectConversation = (conversation) => {
  ...
  // Clear any pending image preview when switching conversations
...
const sendMessage = () => {
  ...
  // If there's a selected image, send it as an image message
  if (selectedImage.value) {
    messageContent = selectedImage.value
    messageType = 'image'
  }
  ...
  activeConversation.value.lastMessage = messageType === 'image' ? 'Sent an image' : newMessage.value
