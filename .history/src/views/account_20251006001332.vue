  ...
  <div class="account-page">
          ...
          <div class="posts-content">
            ...
            <div v-if="activeTab === 'offers'" class="posts-list">
              <div v-for="offer in user.skillOffers" :key="offer.id" class="post-item">
                ...
                <div class="proof-image" v-if="ofcfer.proof">
      ...
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="saveOfferEdit" class="offer-form">
          ...
          <div class="form-actions">
            <button type="button" class="btn cancel-btn1" @click="showEditOfferModal = false">Cancel</button>
            <button type="submit" class="btn submit-btn1">Save Changes</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div v-if="showEditRequestModal" class="modal-overlay" @click="showEditRequestModal = false">
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="saveRequestEdit" class="request-form">
          ...
          <div class="form-actions">
            <button type="button" class="btn cancel-btn1" @click="showEditRequestModal = false">Cancel</button>
            <button type="submit" class="btn submit-btn1">Save Changes</button>
          </div>
        </form>
      </div>
    ...
    <div v-if="showDeleteConfirmation" class="modal-overlay" @click="showDeleteConfirmation = false">
      <div class="modal-content" @click.stop>
        ...
        <div class="form-actions">
          <button type="button" class="btn cancel-btn1" @click="showDeleteConfirmation = false">Cancel</button>
