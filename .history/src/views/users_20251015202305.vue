...
.search-container {
  margin-bottom: 32px; /* slightly bigger space */
  width: calc(66.666% - 1rem); /* Match width of two user containers */
  margin-left: auto;
}
...
.search-bar {
  ...
  padding: 12px 18px; /* made the search bar bigger */
...
.users-count-container {
  ...
  width: calc(33.333% - 1rem); /* Match width of one user container */
  margin-left: auto;
}
