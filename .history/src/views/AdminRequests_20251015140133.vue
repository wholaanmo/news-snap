<template>
  <div class="skill-request-platform">
    ...
    <div class="search-report-container">
      ...
      <button class="reported-posts-btn" @click="showReportedPosts = !showReportedPosts" :class="{ 'request-posts-btn': showReportedPosts }">
    ...
    <div class="header-container">
      <h1 class="requests-header">{{ showReportedPosts ? 'Reported Posts' : 'Requests' }}</h1>
      <div class="request-count">
        {{ showReportedPosts ? 'Total Reported:' : 'Total Requests:' }} <span>{{ showReportedPosts ? reportedPosts.length : filteredPosts.length }}</span>
      </div>
    </div>
...
.request-posts-btn:hover {
  background: #5a7284;
}

.request-posts-btn .material-icons {
  display: none;
}
