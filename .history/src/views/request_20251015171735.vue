        ...
        <form @submit.prevent="submitReport" class="report-form">
          ...
          <div class="proof-upload-section">
            ...
            <div class="file-upload">
              ...
              <span v-if="reportData.proofFile" class="file-name">{{ reportData.proofFile.name }}</span>
            </div>
...
.profile-btn {
  color: var(--grey);
  border: 1px solid var(--grey); /* added full border property */
  background: white; /* optional: keeps background white */
}
