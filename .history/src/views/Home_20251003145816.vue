        ...
        >
          ...
          <div class="card-actions">
            <button class="btn1 report-btn" @click="openReportPopup(request.accountName)">
              <span class="material-icons1">flag</span>
              Report
            </button>
            <button class="btn1 contact-btn">
              <span class="material-icons1">message</span>
              Contact
            </button>
            <button class="btn1 profile-btn">
              <span class="material-icons1">account_circle</span>
              View Profile
            </button>
          </div>
        </div>
