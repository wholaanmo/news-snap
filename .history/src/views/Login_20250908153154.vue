...
body {
            ...
            align-items: center;
            min-height: 100vh;
            background: url('https://images.unsplash.com/photo-1516156008625-3a9d6067fab5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80') no-repeat center center fixed;
...
.container {
    ...
    width: 850px;
    height: 550px;
    background: rgba(255, 255, 255, 0.25); /* slight transparency */
    border-radius: 20px;
