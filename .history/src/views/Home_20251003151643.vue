    ...
    <div v-if="showProfilePopup" class="profile-popup-overlay" @click="closeProfilePopup">
      <div class="profile-popup-container" @click.stop>
        <div class="profile-popup-header">
          <h3>User Profile: {{ viewedUserName }}</h3>
        ...
        <div class="profile-popup-content">
          ...
          <div class="profile-section">
            ...
            <div class="profile-details">
              <div class="detail-item">
                ...
                <span class="detail-value">{{ viewedUserProfile.fullName }}</span>
              </div>
              <div class="detail-item">
                <label>Email Address:</label>
                <span class="detail-value">{{ viewedUserProfile.email }}</span>
              </div>
              <div class="detail-item">
                <label>Phone Number:</label>
                <span class="detail-value">{{ viewedUserProfile.phone }}</span>
              </div>
              <div class="detail-item">
                <label>Government ID:</label>
                <span class="detail-value">{{ viewedUserProfile.governmentId }}</span>
              </div>
              <div class="detail-item">
                <label>Linked Accounts:</label>
                <div class="linked-accounts">
                  <span v-for="account in viewedUserProfile.linkedAccounts" :key="account" class="account-tag">
                    {{ account }}
                  </span>
                </div>
              </div>
          ...
          <div class="profile-section">
            ...
            <div class="posts-container">
              <div v-for="offer in viewedUserProfile.offers" :key="offer.id" class="post-card">
                ...
                <div class="post-content">
                  ...
                  <div class="detail-item">
                    ...
                    <div class="skills-tags">
                      <span v-for="skill in offer.skillsRequested" :key="skill" class="skill-tag">
                        {{ skill }}
                      </span>
                    </div>
                  </div>
                ...
                <div class="post-actions">
                  <button class="btn1 report-btn" @click="openReportPopup(viewedUserName)">
          ...
          <div class="profile-section">
            ...
            <div class="posts-container">
              <div v-for="request in viewedUserProfile.requests" :key="request.id" class="post-card">
                <div class="post-header">
                ...
                <div class="post-content">
                  ...
                  <div class="detail-item">
                    ...
                    <div class="skills-tags">
                      <span v-for="skill in request.skillsOffered" :key="skill" class="skill-tag">
                        {{ skill }}
                      </span>
                    </div>
                  </div>
      ...
      <div class="cards-container">
        ...
        >
          ...
          <div class="card-actions">
            ...
            <button class="btn1 profile-btn" @click="openProfilePopup(request.accountName)">
      ...
      <div class="cards-container">
        ...
        >
          ...
          <div class="card-actions">
            ...
            <button class="btn1 profile-btn" @click="openProfilePopup(offer.accountName)">
              <span class="material-icons">account_circle</span>
              View Profile
            </button>
          </div>
...
const openProfilePopup = (userName) => {
  viewedUserName.value = userName
  // In a real app, you would fetch this data from an API
  // For now, we'll use mock data based on the username
  viewedUserProfile.value = getUserProfileData(userName)
...
const getUserProfileData = (userName) => {
  const profileData = {
    ...
    linkedAccounts: ['Facebook', 'Google', 'LinkedIn'],
    offers: offers.value.filter(offer => offer.accountName === userName).map(offer => ({
      ...offer,
      proof: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=300&h=200&fit=crop'
    })),
    requests: requests.value.filter(request => request.accountName === userName).map(request => ({
      ...request,
      proof: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=300&h=200&fit=crop'
    }))
  }
