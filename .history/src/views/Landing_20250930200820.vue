<template>
  ...
  <div class="sidebar" :class="{ active: sidebarOpen }">
    ...
    <div class="sidebar-links">
      <a href="#home" class="sidebar-link" @click.prevent="scrollToSection('home')">Home</a>
      <a href="#services" class="sidebar-link" @click.prevent="scrollToSection('services')">Services</a>
      <a href="#guide" class="sidebar-link" @click.prevent="scrollToSection('guide')">Guide</a>
      <a href="#footer" class="sidebar-link" @click.prevent="scrollToSection('footer')">Contact Us</a>
    </div>
  </div>
    ...
    <div class="hero-content">
      <div class="hero-container">
        ...
        <div class="hero-buttons">
          <a href="#services" class="cta-button primary" @click.prevent="scrollToSection('services')">Learn More</a>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    scrollToSection(sectionId) {
      ...
      if (element) {
        const offset = 70; // Height of your navbar
...
/* The rest of your existing CSS styles remain exactly the same... */
/* Hero Section */
.hero-section {
  min-height: 100vh;
  display: flex;
