<template>
  ...
  const requests = ref([
    ...
    },
    {
      ...
      description: 'Need a photographer for product photography for my online store.',
      category: 'Photography',
      location: 'Miami, FL',
      skillsOffered: ['Social Media Marketing', 'Copywriting', 'Customer Service'],
      schedule: 'Weekdays, flexible timing',
      additionalNotes: 'Experience with e-commerce photography is a plus.'
    },
    {
      id: 5,
      accountName: 'RobertBrown',
      profilePic: 'https://images.unsplash.com/photo-1507591064344-4c6ce005b128?w=150&h=150&fit=crop&crop=face',
      timePosted: '7 hours ago',
      request: 'Fitness Training',
      description: 'Looking for a personal trainer to help with weight loss and strength training.',
      category: 'Fitness',
      location: 'Seattle, WA',
      skillsOffered: ['Meal Planning', 'Yoga Instruction', 'Nutrition Advice'],
      schedule: 'Early mornings or evenings',
      additionalNotes: 'Prefer someone with experience working with beginners.'
    }
  ])
  ...
  const offers = ref([
    ...
    {
      id: 4,
      accountName: 'LisaTaylor',
      profilePic: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&h=150&fit=crop&crop=face',
      timePosted: '4 hours ago',
      skills: ['Photography', 'Photo Editing', 'Portrait Photography', 'Product Photography'],
      description: 'Professional photographer offering photography services for events, portraits, and commercial projects.',
      category: 'Photography',
      location: 'Austin, TX',
      skillsRequested: ['Marketing', 'Social Media Management', 'Graphic Design'],
      schedule: 'Flexible, including weekends',
      additionalNotes: 'Fully equipped studio available. Can travel to locations.'
    },
    {
      id: 5,
      accountName: 'JamesWilson',
      profilePic: 'https://images.unsplash.com/photo-1517070208541-6ddc4d3efbcb?w=150&h=150&fit=crop&crop=face',
      timePosted: '2 hours ago',
      skills: ['Personal Training', 'Nutrition Coaching', 'Weight Training', 'Yoga'],
      description: 'Certified personal trainer offering customized fitness programs and nutritional guidance.',
      category: 'Fitness',
      location: 'Denver, CO',
      skillsRequested: ['Meal Preparation', 'Sports Massage', 'Physical Therapy'],
      schedule: 'Early mornings and evenings',
      additionalNotes: 'Specialized in weight loss and muscle building programs.'
    }
  ])
  ...
  /* Card Styles - Fixed width for horizontal scroll */
  .request-card,
  .offer-card {
    background: white;
    border-radius: 16px;
