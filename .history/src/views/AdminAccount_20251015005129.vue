      ...
      <div class="modal-content deactivated-modal" @click.stop>
        ...
        <div class="modal-body">
          ...
          >
            ...
            <button class="btn reactivate-btn" @click="reactivateAccount(account.id)">
              Reactivate Account
            </button>
          </div>
        </div>
          ...
          >
            <div class="post-header">
              <div class="post-user-info">
                ...
                <span class="user-full-name">{{ post.userFullName }}</span>
              </div>
            ...
            <div class="post-actions">
              <button class="btn view-profile-btn" @click="openProfileModal(post.userId)">
                View Profile
              </button>
            </div>
          </div>
...
const keptPosts = ref([
  ...
  },
  {
    ...
    userProfilePicture: 'https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=100&q=80'
  }
])
    ...
    skillRequests: [
      {
        ...
        category: 'Design',
        location: 'Remote',
        skillsOffered: 'Social Media Management',
...
const openProfileModal = (userId) => {
  currentProfile.value = sampleProfiles[userId] || sampleProfiles[1]
