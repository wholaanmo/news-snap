<template>
  <div class="account-page" :class="{'sidebar-collapsed': !sidebarExpanded, 'sidebar-expanded': sidebarExpanded}">
...
// Define props to accept sidebar state
...
.account-page.sidebar-collapsed {
  margin-left: calc(3.5rem + 32px); /* Match sidebar collapsed width */
}

/* Sidebar expanded state */
.account-page.sidebar-expanded {
  margin-left: var(--sidebar-width, 280px); /* Use CSS variable from your sidebar */
}
...
/* Enhanced Responsive Design for Sidebar States */
