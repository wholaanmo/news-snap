    ...
    return {
      ...
      allUsers: [
        ...
        },
        {
          ...
          isVerified: true,
          linkedAccounts: [
            { platform: 'GitHub', icon: 'code', url: 'https://github.com/michaelb' }
          ],
          skillOffers: [
            {
              id: 1,
              ...
              category: 'Design',
              location: 'Remote',
              skillsRequested: 'UI/UX feedback',
              schedule: 'Weekdays'
            }
          ],
          skillRequests: []
...
/* Users Grid Styles - Updated to 3 containers per row */
.users-grid {
  display: grid;
...
/* Profile Modal Styles - Exactly as you provided */
.profile-modal {
  max-width: 800px;
  max-height: 95vh;
}
