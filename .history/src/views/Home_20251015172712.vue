<template>
      ...
      <div class="report-popup-container" @click.stop>
        ...
        <div class="report-popup-content">
          ...
          <div class="proof-upload-section">
            <label class="proof-label">Proof (Optional)</label>
            ...
            <p class="proof-hint">You can upload images, PDFs, or documents as evidence</p>
          </div>
          <div class="report-actions">
            <button class="btn cancel-btn1" @click="closeReportPopup">Cancel</button>
    ...
    <div v-if="showProfileModal" class="modal-overlay" @click="closeProfileModal">
      <div class="modal-content profile-modal" @click.stop>
            ...
            <div class="posts-list">
              <div v-for="offer in currentProfile.skillOffers" :key="offer.id" class="profile-post-card">
                ...
                <div class="post-actions">
                  <button class="btn2 report-btn2" @click="openReportModalFromProfile(offer, currentProfile.fullName)">
        ...
        <div class="profile-actions">
          <button class="btn2 close-btn" @click="closeProfileModal">Close</button>
        </div>
      </div>
    </div>
  ...
  <span class="detail-value">{{ request.skillsOffered.join(', ') }}</span>
</div>
            <div class="detail-item">
      ...
      <div class="cards-container">
        ...
        >
          ...
          <div class="card-content">
            <div class="detail-item">
  <label>Skills:</label>
  <span class="detail-value">{{ offer.skills.join(', ') }}</span>
</div>
            <div class="detail-item">
              <label>Description:</label>
  ...
  <span class="detail-value">{{ offer.skillsRequested.join(', ') }}</span>
</div>
            <div class="detail-item">
              <label>Schedule:</label>
              <span class="detail-value">{{ offer.schedule }}</span>
...
.dashboard {
  ...
  margin: 0 auto;
  margin-left: 2rem;
  margin-right: 0rem; /* Added equal right margin */
}
